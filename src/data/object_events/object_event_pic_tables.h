...
// New overworld pic tables for Pokemon Tractors
...
static const struct SpriteFrameImage sPicTable_GenesisF[] = {
    overworld_ascending_frames(gObjectEventPic_GenesisF, 4, 4),
};

static const struct SpriteFrameImage sPicTable_GenesisM[] = {
    overworld_ascending_frames(gObjectEventPic_GenesisM, 4, 4),
};
...
static const struct SpriteFrameImage sPicTable_PokemonRangerF[] = {
    overworld_ascending_frames(gObjectEventPic_PokemonRangerF, 4, 4),
};

static const struct SpriteFrameImage sPicTable_PokemonRangerM[] = {
    overworld_ascending_frames(gObjectEventPic_PokemonRangerM, 4, 4),
};
